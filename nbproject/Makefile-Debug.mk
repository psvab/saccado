...
${OBJECTDIR}/Core/Component.o: Core/Component.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Component.o Core/Component.cpp

${OBJECTDIR}/Core/ComponentManager.o: Core/ComponentManager.cpp
	${MKDIR} -p ${OBJECTDIR}/Core
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/ComponentManager.o Core/ComponentManager.cpp

${OBJECTDIR}/Core/EventQ.o: Core/EventQ.cpp
	${MKDIR} -p ${OBJECTDIR}/Core
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/EventQ.o Core/EventQ.cpp

${OBJECTDIR}/Core/Logger.o: Core/Logger.cpp
	${MKDIR} -p ${OBJECTDIR}/Core
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Logger.o Core/Logger.cpp

${OBJECTDIR}/Core/Network.o: Core/Network.cpp
	${MKDIR} -p ${OBJECTDIR}/Core
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Network.o Core/Network.cpp

${OBJECTDIR}/Exchg/MDLink.o: Exchg/MDLink.cpp
	${MKDIR} -p ${OBJECTDIR}/Exchg
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exchg/MDLink.o Exchg/MDLink.cpp

${OBJECTDIR}/Exchg/TradingLink.o: Exchg/TradingLink.cpp
	${MKDIR} -p ${OBJECTDIR}/Exchg
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exchg/TradingLink.o Exchg/TradingLink.cpp

${OBJECTDIR}/Instref/Instref.o: Instref/Instref.cpp
	${MKDIR} -p ${OBJECTDIR}/Instref
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Instref/Instref.o Instref/Instref.cpp

${OBJECTDIR}/Strategy/Strategy.o: Strategy/Strategy.cpp
	${MKDIR} -p ${OBJECTDIR}/Strategy
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Strategy/Strategy.o Strategy/Strategy.cpp

${OBJECTDIR}/Util/MDSender.o: Util/MDSender.cpp
	${MKDIR} -p ${OBJECTDIR}/Util
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Util/MDSender.o Util/MDSender.cpp

${OBJECTDIR}/Util/MockExchange.o: Util/MockExchange.cpp
	${MKDIR} -p ${OBJECTDIR}/Util
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Util/MockExchange.o Util/MockExchange.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
...
${OBJECTDIR}/Core/Component_nomain.o: ${OBJECTDIR}/Core/Component.o Core/Component.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Component_nomain.o Core/Component.cpp;\
	else  \
...
${OBJECTDIR}/Core/ComponentManager_nomain.o: ${OBJECTDIR}/Core/ComponentManager.o Core/ComponentManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/ComponentManager_nomain.o Core/ComponentManager.cpp;\
	else  \
...
${OBJECTDIR}/Core/EventQ_nomain.o: ${OBJECTDIR}/Core/EventQ.o Core/EventQ.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/EventQ_nomain.o Core/EventQ.cpp;\
	else  \
...
${OBJECTDIR}/Core/Logger_nomain.o: ${OBJECTDIR}/Core/Logger.o Core/Logger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Logger_nomain.o Core/Logger.cpp;\
	else  \
...
${OBJECTDIR}/Core/Network_nomain.o: ${OBJECTDIR}/Core/Network.o Core/Network.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Network_nomain.o Core/Network.cpp;\
	else  \
...
${OBJECTDIR}/Exchg/MDLink_nomain.o: ${OBJECTDIR}/Exchg/MDLink.o Exchg/MDLink.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exchg/MDLink_nomain.o Exchg/MDLink.cpp;\
	else  \
...
${OBJECTDIR}/Exchg/TradingLink_nomain.o: ${OBJECTDIR}/Exchg/TradingLink.o Exchg/TradingLink.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exchg/TradingLink_nomain.o Exchg/TradingLink.cpp;\
	else  \
...
${OBJECTDIR}/Instref/Instref_nomain.o: ${OBJECTDIR}/Instref/Instref.o Instref/Instref.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Instref/Instref_nomain.o Instref/Instref.cpp;\
	else  \
...
${OBJECTDIR}/Strategy/Strategy_nomain.o: ${OBJECTDIR}/Strategy/Strategy.o Strategy/Strategy.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Strategy/Strategy_nomain.o Strategy/Strategy.cpp;\
	else  \
...
${OBJECTDIR}/Util/MDSender_nomain.o: ${OBJECTDIR}/Util/MDSender.o Util/MDSender.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Util/MDSender_nomain.o Util/MDSender.cpp;\
	else  \
...
${OBJECTDIR}/Util/MockExchange_nomain.o: ${OBJECTDIR}/Util/MockExchange.o Util/MockExchange.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Util/MockExchange_nomain.o Util/MockExchange.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Igtest -ICore -I. -IExchg -IInstref -IUtil -IStrategy -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
